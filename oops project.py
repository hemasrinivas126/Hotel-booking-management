...
def restaurant():
    ...
    if ph_no in temp_record:
        ...
        print("Your payment is succesfull")
        home()
...
def customer_data():
    ...
    data=pd.DataFrame({"names":per_name,"mobile no":per_phone,"address":per_address,"room no":per_room,"check in":per_check_in,
